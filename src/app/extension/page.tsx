      ...
      <div className="text-center space-y-3">
        ...
        <div className="pt-2 flex flex-wrap justify-center gap-3">
          <a
            ...
            className="bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-bold px-6 py-3 rounded-xl text-sm transition-all shadow-lg shadow-emerald-500/20 flex items-center gap-2"
          >
          ...
          <Link
            href="/dashboard"
            className="bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold px-5 py-3 rounded-xl text-sm transition-all border border-slate-700 flex items-center gap-2"
          >
